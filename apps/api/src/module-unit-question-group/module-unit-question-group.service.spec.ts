...
describe('ModuleUnitQuestionGroupService (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    service = module.get<ModuleUnitQuestionGroupService>(ModuleUnitQuestionGroupService);
  ...
  it('creates and retrieves question groups', async () => {

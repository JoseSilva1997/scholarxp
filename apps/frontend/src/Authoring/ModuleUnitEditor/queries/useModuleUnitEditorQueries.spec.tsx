...
vi.mock('@/Authoring/api/modules', async () => {
  const actual = await vi.importActual('@/Authoring/api/modules');
  return {
    ...actual,
...
vi.mock('@/Authoring/ModuleUnitEditor/api/questions', async () => {
  const actual = await vi.importActual('@/Authoring/ModuleUnitEditor/api/questions');
  return {
    ...actual,

...
vi.mock('@/DailyPractice/queries/useDailyPracticeQueries', () => ({
...
vi.mock('@/shared/hooks/page-state/useModuleProgressAnimation', () => ({
...
import { useDailyPracticePageState } from '@/DailyPractice/page-state/useDailyPracticePageState';
import {

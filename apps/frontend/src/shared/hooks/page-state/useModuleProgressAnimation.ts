// Owns all module-XP progress animation state: server sync, smooth bar animation,
// XP gain chip, and level-up celebration. Shared by both the practice room and daily
// practice flows so each page-state hook only has to pass in server data and call applyExpAward.

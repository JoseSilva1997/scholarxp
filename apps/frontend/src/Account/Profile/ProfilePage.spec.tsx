...
vi.mock('@/Account/Profile/page-state/useProfilePageState', () => ({
...
vi.mock('@/Account/Profile/components/HeroCard', () => ({
  default: ({
    user,
    masterQuestStreak,
  }: {
...
vi.mock('@/Account/Profile/components/StudentProfile', () => ({
  default: ({ moduleSortKey }: { moduleSortKey: string }) => (
    <div>student-profile:{moduleSortKey}</div>
  ),
}));

vi.mock('@/Account/Profile/components/TutorProfile', () => ({

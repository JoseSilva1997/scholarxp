...
import type { ProgressModuleDetail, ExpBreakdown } from '@/Practice-Room/page-state/useModuleProgressAnimation';
import type { ActivePracticeQuestion } from '@/Practice-Room/page-state/usePracticeRoomInteractionState';
